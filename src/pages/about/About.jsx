...
function About() {
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold text-center mb-8 text-purple-900 uppercase" style={{color : '#3C2A21'}}>About Us</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-center">
          <p className="text-sm text-gray-800 mb-4 leading-relaxed uppercase" style={{color : '#3C2A21'}}>
