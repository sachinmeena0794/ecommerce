                ...
                <div>
                    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mt-4">
                        <select
                            ...
                            className="px-4 py-3 w-full rounded-md bg-gray-50 border border-gray-300 hover:border-gray-500 focus:border-gray-500 outline-none focus:bg-white focus:ring-2 focus:ring-gray-300 text-sm transition-colors duration-300 ease-in-out"
                        >
