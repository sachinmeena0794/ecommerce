    ...
    <tr>
        ...
        <th className="px-6 py-3" onClick={() => handleSort('date')}>
            ...
            <div className="flex justify-center mt-5">
                <button disabled={pageIndex === 0} onClick={() => setPageIndex(pageIndex - 1)} className="px-4 py-2 mr-2 bg-gray-300 hover:bg-gray-400 rounded">Previous</button>
                <button disabled={(pageIndex + 1) * pageSize >= order.length} onClick={() => setPageIndex(pageIndex + 1)} className="px-4 py-2 bg-gray-300 hover:bg-gray-400 rounded">Next</button>
            </div>
        </div>
    );
}
